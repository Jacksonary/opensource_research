...
import com.zhaogang.netty.client.handler.UnixTimeClientHandler;
import com.zhaogang.netty.client.decoder.UnixTimeDecoder;
...
//                        ch.pipeline().addLast(new TimeDecoder(), new TimeClientHandler());
        ...
        try {
            // 客户端是connect，不是bind
            ChannelFuture future = boss.connect("127.0.0.1", 8081).sync();
