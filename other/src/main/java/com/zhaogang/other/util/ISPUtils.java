...
public class ISPUtils {
    private static final Logger LOGGER = LoggerFactory.getLogger(ISPUtils.class);

    // 生成 app_secret 密钥
    private final static String SERVER_NAME = "mmt_isp";
    ...
    public static String md5str(String str) {
        ...
        try {
            ...
            LOGGER.error(">> get md5Digest failed", e);
            return "";
        }
        ...
        byte[] md5Bytes = md5Digest.digest(byteArr);
